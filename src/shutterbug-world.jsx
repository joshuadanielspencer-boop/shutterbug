...
// (Landmark isn't imported: it is the icon fallback INSIDE Photo, and nothing here
// reaches for it directly.)
import { ArtBadge, withWidth, Photo, PhotoCredit, DevelopImg } from "./components/media.jsx";
