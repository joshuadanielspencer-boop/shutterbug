...
export const TRANSPORT_MODES = [
  ...
  { id: "cograil",  name: "Cog railway",     emoji: "🚞", speed: 1, cost: 2, contexts: ["cograil"], blurb: "A cog railway has a toothed center rail its wheels grip, so it can climb mountainsides far too steep for an ordinary train." },
