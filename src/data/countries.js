...
export const COUNTRY_INFO = {
  ...
  "Namibia": { capital: "Windhoek", region: "Southern Africa", blurb: "Namibia lies along the Atlantic coast of Southern Africa, with its capital at Windhoek. It is home to the Namib, one of the oldest deserts on Earth, where rust-red sand dunes at Sossusvlei rise hundreds of metres high." },
  ...
  "Zambia": { capital: "Lusaka", region: "Southern Africa", blurb: "Zambia, a landlocked country in Southern Africa, is ruled from its central capital Lusaka. Threaded by the Zambezi River, it shares the thundering Victoria Falls and the huge man-made Lake Kariba with its neighbours." },
  ...
  "China": { capital: "Beijing", region: "East Asia", blurb: "China is a vast country in East Asia, and its capital is Beijing. The Great Wall of China winds for thousands of kilometres across its hills, and China's misty bamboo forests are the only wild home of the black-and-white giant panda." },
  ...
  "Japan": { capital: "Tokyo", region: "East Asia", blurb: "Japan is an island nation in East Asia, and its capital is the huge city of Tokyo. Its most famous sight is Mount Fuji, a snow-capped volcano, and speedy bullet trains called shinkansen zip travellers across the country." },
  "Jordan": { capital: "Amman", region: "Middle East", blurb: "Jordan is a country in the Middle East, and its capital is Amman. It shares the shore of the Dead Sea, the lowest dry land on Earth, and hides Petra, an ancient city carved straight into rose-coloured rock." },
  ...
  "Nepal": { capital: "Kathmandu", region: "South Asia", blurb: "Nepal is a country in South Asia, and its capital is Kathmandu. Along its northern border rise the Himalaya mountains, including Mount Everest, the highest mountain on Earth at about 8,849 metres above sea level." },
  ...
  "United Arab Emirates": { capital: "Abu Dhabi", region: "Middle East", blurb: "The United Arab Emirates is a country in the Middle East, and its capital is Abu Dhabi, not its most famous city, Dubai. Rising from the desert in Dubai is the Burj Khalifa, the tallest building in the world at over 800 metres." },
  ...
  // ---- Oceania ----
  "Australia": { capital: "Canberra", region: "Australasia", blurb: "Australia is a huge island continent in Australasia, and its capital is Canberra, not the bigger cities of Sydney and Melbourne. Off its northeast coast lies the Great Barrier Reef, the world's largest coral reef, stretching more than 2,300 kilometres." },
  ...
  "Denmark": { capital: "Copenhagen", region: "Scandinavia", blurb: "Denmark is a Scandinavian country of green islands and windy coasts, and its capital, Copenhagen, is famous for bicycles and colourful harbour houses. LEGO bricks were invented here — a Danish carpenter named the toy after the Danish words for 'play well.'" },
