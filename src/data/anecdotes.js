...
export const ANECDOTES = {
  paris: "On a hot day the iron soaks up the sun and the whole tower can grow about six inches (fifteen centimeters) taller — then it shrinks back once the weather cools!",
  ...
  uluru: "The giant red rock you see is only the tip — most of Uluru keeps going underground, plunging down for kilometers beneath the desert like a hidden iceberg!",
  niagara: "The rushing water is slowly nibbling the rock away, so the falls are very gradually creeping upstream — over thousands of years they've marched several kilometers backward!",
  victoriafalls: "The local name is Mosi-oa-Tunya — 'the smoke that thunders' — because the mighty spray rises like a cloud you can spot from dozens of kilometers away!",
  ...
  toubamosque: "The city's name means 'bliss,' and its great central minaret has a name all its own — Lamp Fall — honoring one of the founder's most devoted followers.",
  ...
  nyiragongo: "Nyiragongo's lava is unusually runny, so when the crater walls broke in 1977 the molten rock poured downhill at up to about 62 miles (100 kilometers) an hour — some of the fastest lava flows ever recorded.",
  ...
  sidibousaid: "The painter Paul Klee arrived here on Easter Monday in 1914, and was so dazzled by the town's color and light that the visit transformed the way he painted forever.",
  ...
  fishrivercanyon: "Adventurers can hike a famous 56-mile (90-kilometer) trail along the canyon floor, usually about five days — one of the most popular wilderness treks in southern Africa.",
  ...
  riocelestefalls: "The blue appears suddenly at a spot called 'Los Teñideros' ('the dyers'), where two clear, colorless rivers join and the water instantly turns turquoise.",
  ...
  trinidadcuba: "Just outside town rises the 148-foot (45-meter) Manaca Iznaga tower, built in 1816 — a lookout over the sugar plantations and one of Cuba's tallest colonial-era structures.",
  ...
  jacmel: "Every year Jacmel's artists parade in enormous, brightly painted papier-mâché masks — animals, spirits and heroes — for one of Haiti's most colorful carnivals.",
  ...
  shellbeach: "The leatherback is the largest sea turtle on Earth, growing over six feet (two meters) long and weighing more than half a ton (about half a tonne).",
  ...
  saltomonday: "They lie only about 6.2 miles (10 kilometers) from the far larger Iguazú Falls, yet stay much quieter and less crowded.",
  ...
  quitocentro: "Quito sits about 9,350 feet (2,850 meters) up in the Andes, making it one of the highest capital cities in the world, and it lies just a few kilometers from the equator.",
  // --- Oceania wave (verified 2026-07-10) ---
  mountrotui: "Moorea sits about 11 miles (17 kilometers) northwest of Tahiti, and a ferry crosses between the two islands in well under an hour.",
  ...
  tavurvur: "Rabaul sits inside a giant flooded volcanic crater called a caldera, which forms Simpson Harbour — one of the finest natural harbors in the Pacific.",
  ...
  manatee: "These gentle giants can top 1,000 pounds (about 450 kg) and are distant cousins of the elephant, my dear, and weary sailors of old sometimes mistook them for mermaids.",
  ...
  potalapalace: "Its thirteen stories hold more than a thousand rooms. The outer White Palace was for daily life and government, while the inner Red Palace was for prayer and study, and holds the jeweled tombs of past Dalai Lamas.",
  ...
  zhangyedanxia: "Each color comes from a different mineral, with iron giving the reds and yellows, and the stripes glow their brightest just after rain or in the low light of sunrise and sunset.",
  hukouwaterfall: "Its name means 'the spout of a teapot': upstream the river spreads hundreds of meters wide, then funnels into a rocky channel only about sixty-five feet (twenty meters) across before it thunders down.",
  ...
  longmengrottoes: "The largest figure, a serene Buddha some seventeen meters tall, was carved in the 600s with money donated by Empress Wu Zetian, and by tradition its calm face was modelled on her own.",
  ...
  dunedupilat: "Driven by the wind, the dune creeps slowly inland by up to a few meters each year, gradually burying the forest and roads behind it.",
  verdongorge: "The river takes its name from its striking green color, and its towering limestone walls draw rock climbers from around the world.",
  ...
  corinthcanal: "The canal is only about 79 feet (24 meters) wide at the water's surface, too narrow for most modern ships, so large vessels must be towed through by tugboats; the Roman emperor Nero had begun digging a canal here by hand in AD 67, nearly 1,800 years before it was finished.",
  ...
  olympus: "Though people had lived in its shadow for thousands of years, the summit of Mytikas was not reached by recorded climbers until 1913, when two Swiss travelers and a Greek guide named Christos Kakkalos first stood on top.",
  ...
  heidelberg: "Inside the castle stands the Heidelberg Tun, one of the world's largest wine barrels, built in 1751 and able to hold about 220,000 liters; it is so vast that a dance floor was built on top of it.",
  bastei: "The stone Bastei Bridge is 251 feet (76.5 meters) long and its seven arches span a ravine about 131 feet (40 meters) deep; it replaced an earlier wooden bridge from the 1820s that could no longer handle the growing crowds of visitors.",
  ...
  hopewellrocks: "At low tide you can walk on the sea floor right around the base of the towering 'flowerpots', but only a few hours later that same ground lies buried under many meters of seawater.",
  ...
  popocatepetl: "An old Nahuatl legend casts Popocatépetl as a warrior and the neighboring dormant volcano Iztaccíhuatl — whose snowy ridge looks like a reclining figure — as his sleeping beloved, 'the White Woman.'",
  ...
  bellasartes: "The theater's stage curtain is a shimmering stained-glass mosaic made by Tiffany from nearly a million pieces of glass, depicting the two volcanoes Popocatépetl and Iztaccíhuatl over the Valley of Mexico.",
  ...
  budapest: "Its dome stands exactly 315 feet (96 meters) tall on purpose — a nod to the year 896, when the Magyar people first arrived, and to 1896, a thousand years later!",
  copenhagen: "This picture-perfect harbor was once a rough, rowdy dock crowded with sailors, taverns and tattoo parlours — quite the change from the postcard spot it is today!",
  ...
  pontdugard: "The whole thirty-mile (fifty-kilometer) channel it belonged to sloped so gently that the water fell only about forty feet (twelve meters) along its entire length — a masterpiece of careful measuring!",
  ...
  fes: "In its ancient tanneries, workers still dye leather by hand in stone pots of color just as they have for centuries — and visitors are handed a sprig of mint to sniff against the smell!",
  xian: "No two of the clay soldiers share the same face — and each was once painted in bright colors, though the paint often flakes away within minutes of meeting the air after two thousand years underground!",
  ...
  everest: "It's still growing! The slow-motion crash of two great slabs of the Earth's crust pushes the mountain a few millimeters taller every single year.",
  ...
  zhangjiajie: "One towering pillar is climbed by a glass lift built right onto the cliff face — the tallest outdoor elevator in the world, whisking visitors over a thousand feet (more than three hundred meters) up in a couple of minutes!",
};
