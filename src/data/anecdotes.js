...
export const ANECDOTES = {
  paris: "On a hot day the iron soaks up the sun and the whole tower can grow about six inches (fifteen centimetres) taller — then it shrinks back once the weather cools!",
  ...
  nyiragongo: "Nyiragongo's lava is unusually runny, so when the crater walls broke in 1977 the molten rock poured downhill at up to about 62 miles (100 kilometres) an hour — some of the fastest lava flows ever recorded.",
  ...
  fishrivercanyon: "Adventurers can hike a famous 56-mile (90-kilometre) trail along the canyon floor, usually about five days — one of the most popular wilderness treks in southern Africa.",
  ...
  trinidadcuba: "Just outside town rises the 148-foot (45-metre) Manaca Iznaga tower, built in 1816 — a lookout over the sugar plantations and one of Cuba's tallest colonial-era structures.",
  ...
  shellbeach: "The leatherback is the largest sea turtle on Earth, growing over six feet (two metres) long and weighing more than half a ton (about half a tonne).",
  ...
  saltomonday: "They lie only about 6.2 miles (10 kilometres) from the far larger Iguazú Falls, yet stay much quieter and less crowded.",
  ...
  quitocentro: "Quito sits about 9,350 feet (2,850 metres) up in the Andes, making it one of the highest capital cities in the world, and it lies just a few kilometres from the equator.",
  // --- Oceania wave (verified 2026-07-10) ---
  mountrotui: "Moorea sits about 11 miles (17 kilometres) northwest of Tahiti, and a ferry crosses between the two islands in well under an hour.",
  ...
  hukouwaterfall: "Its name means 'the spout of a teapot': upstream the river spreads hundreds of metres wide, then funnels into a rocky channel only about sixty-five feet (twenty metres) across before it thunders down.",
  ...
  corinthcanal: "The canal is only about 79 feet (24 metres) wide at the water's surface, too narrow for most modern ships, so large vessels must be towed through by tugboats; the Roman emperor Nero had begun digging a canal here by hand in AD 67, nearly 1,800 years before it was finished.",
  ...
  bastei: "The stone Bastei Bridge is 251 feet (76.5 metres) long and its seven arches span a ravine about 131 feet (40 metres) deep; it replaced an earlier wooden bridge from the 1820s that could no longer handle the growing crowds of visitors.",
  ...
  budapest: "Its dome stands exactly 315 feet (96 metres) tall on purpose — a nod to the year 896, when the Magyar people first arrived, and to 1896, a thousand years later!",
  ...
  pontdugard: "The whole thirty-mile (fifty-kilometre) channel it belonged to sloped so gently that the water fell only about forty feet (twelve metres) along its entire length — a masterpiece of careful measuring!",
  ...
  zhangjiajie: "One towering pillar is climbed by a glass lift built right onto the cliff face — the tallest outdoor elevator in the world, whisking visitors over a thousand feet (more than three hundred metres) up in a couple of minutes!",
};
